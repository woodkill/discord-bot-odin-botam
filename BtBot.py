...
APP_ID_DEV = 1110542318127304745 #1081829204359913542
APP_ID_REAL = 1110533560189853696 #1074530999947493438
...
class BtBot(commands.Bot):
    ...
    async def on_ready(self):
        ...
        self.logger.debug(f"{self.odin_guilds_dic}")
    ...
    async def on_guild_join(self, guild):
        ...
        # self.debug.info(f"{self.odin_guilds_dic}")
